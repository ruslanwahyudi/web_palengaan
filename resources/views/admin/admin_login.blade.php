...
>
  ...
  <body>
    ...
    <div class="container-xxl" style="background-color: rebeccapurple;">
            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">Kecamatan Palengaan</span>
                </a>
              </div>
              <!-- /Logo -->
              <!-- <h4 class="mb-2">Welcome to Official Web Kec. Palengaan! 👋</h4> -->
