...
<div class="content-wrapper">
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <p class="card-title">Daftar Permohonan Rekomendasi Nikah</p>
                        ...
                        <div class="col-12">
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        @foreach($data_rekomnikah as $item)
                                        <tr>
                                            <td class="py-1">
                                                {{$item->id}}
                                                ...
                                                <a href="{{ route('checklist.layanan', ['id' => $item->id_transaksi]) }}" data-confirm-delete="true">
                                                    ...
                                                    @switch($item->status_transaksi)
                                                        ...
                                                        @case(1)
                                                            ...
                                                            @break
                                                        @case(2)
                                                            <span  style="background-color: fuchsia; padding:10px; color:black;">Selesai</span>
                                                            @break
                                                        @default
                                                            <span>Something went wrong, please try again</span>
                                                    @endswitch 
