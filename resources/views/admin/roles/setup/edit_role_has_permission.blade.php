                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label"></label>
                                <div class="col-sm-4">
                                    <!-- -- {{ $model->id }} -> {{ App\Models\User::roleHasPermissionsGroup($model->id, $permissions, $permissionGroupsItem->group_name) }} -->
                                    <div class="form-check mt-3">
                                        <input class="form-check-input" type="checkbox" value="" id="defaultCheck1" {{ App\Models\User::roleHasPermissionsGroup($model->id, $permissions, $permissionGroupsItem->group_name) == true ? 'checked' : '' }} />
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-check mt-3">
                                        <input class="form-check-input" type="checkbox" name="permission[]" value="{{ $permissionByGroupnameItem->id }}" id="defaultCheck{{ $permissionByGroupnameItem->id }}"  {{ $model->hasPermissionTo($permissionByGroupnameItem->name) ? 'checked' : '' }} />
